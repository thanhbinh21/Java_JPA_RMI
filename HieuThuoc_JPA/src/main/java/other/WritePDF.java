...
//    public void printPhieuNhap(PhieuNhapThuoc pn, List<ChiTietPhieuNhapThuoc> listCTPN) {
//        String url = "";
//        try {
//            fd.setTitle("In hóa đơn");
//            fd.setLocationRelativeTo(null);
//            url = getFile(pn.getMaPN());
...
//            document.open();
//
//            Paragraph company = new Paragraph("Hiệu thuốc tây Yên Tâm", fontBold15);
...
//
//            Paragraph paragraph1 = new Paragraph("Mã phiếu: " + pn.getMaPN(), fontNormal10);
//
//            String kh = pn.getNcc().getTen();
//            Paragraph paragraph2 = new Paragraph("Nhà cung cấp: " + kh, fontNormal10);
//            paragraph2.add(new Chunk(createWhiteSpace(5)));
//
//            String nv = pn.getNhanVien().getHoTen();
//            Paragraph paragraph3 = new Paragraph("Người thực hiện: " + nv, fontNormal10);
//            paragraph3.add(new Chunk(createWhiteSpace(5)));
//
//            Paragraph paragraph4 = new Paragraph("Thời gian: " + formatDate.format(pn.getThoiGian()), fontNormal10);
